...
//     (parser->op_stack->top->token->type == REDIR_IN ||
//     parser->op_stack->top->token->type == REDIR_OUT ||
//     parser->op_stack->top->token->type == APPEND ||
//     parser->op_stack->top->token->type == HEREDOC))
//     {
